...
Bài: "Rated at the Peak? Firm Valuation around the First LSEG ESG Score in Five Southeast Asian Markets"
...
| 06_Cover_Letter.docx | Cover Letter | Dán số từ **6,165** vào ô Cover letter trên hệ thống |
...
## 2. Thông số đã kiểm tra bằng script (checks.py: 102/102 PASS)

- [x] Thân bài 6,165 từ ≤ giới hạn 6,200 (7.000 − 200 × 4 exhibit); abstract ≤ 100 từ; keywords ≤ 7, xếp chữ cái; có JEL.
...
- [ ] Keywords nhập cách nhau bằng dấu chấm phẩy: Difference-in-differences; ESG ratings; Firm valuation; Rating coverage; Selection; Southeast Asia; Staggered adoption.
